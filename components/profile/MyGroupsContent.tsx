...
type MyGroupsContentProps = {
  activeTab: ActiveTabTypes;
  setActiveTab: (activeTab: ActiveTabTypes) => void;
};

const MyGroupsContent: FC<MyGroupsContentProps> = ({
  activeTab,
  setActiveTab,
}) => {
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex space-x-4">
          <button
            ...
            className="bg-white border border-indigo-600 text-indigo-600 hover:bg-indigo-50 px-4 py-2 rounded-button transition-colors cursor-pointer whitespace-nowrap"
          >
